...
#      | Adipati   | Dolken   | adipati_dolken123@yahoo.com    |
...
#      | mr    | Ten       | Lee      | https://randomuser.me/api/portraits/men/61.jpg | male   | ten_lee123@yahoo.com   | 1996-02-27  | +613372837823 | Wutthakad Road | Bangkok | Chomthong | Thailand | GMT+7    |
#    When Saya mengirim permintaan POST untuk create user
#    Then Kode respons adalah 200
#    And Responnya harus sesuai dengan JSONSchema "create-schema.json"
#
...
#    Given Saya memiliki data user
#      | title | firstName | lastName | picture                                          | gender | email                       | dateOfBirth               | phone        | street          | city        | state    | country                  | timezone |
#      | mrs   | Angelina  | Jolie    | https://randomuser.me/api/portraits/women/60.jpg | female | angelina_jolie234@yahoo.com | 1975-06-04T08:26:49.610Z  | +91091212292 | S. Roberts Road | Palos Hills | Illinois | United States of America | 4        |
#    When Saya mengirim permintaan POST untuk create user
#    Then Kode respons adalah 400
